...
Threadsを始めて90日。フォロワー0人からスタートして、2,000人まで増やすことができました。

「何を投稿したらフォロワーが増えるの？」

これ、Threadsを始めた人なら誰でも気になることだと思います。

そこで今回は、90日分の**毎日のフォロワー増減データ**を分析して、「フォロワーが一気に増えた日」に共通するパターンを3つの型に整理してみました。
...
- **Day38〜39**（08/07〜08/08）：+65 → +48（翌日も74%を維持）
- **Day71〜72**（09/09〜09/10）：+55 → +40（翌日も73%を維持）
- **Day76〜77**（09/14〜09/15）：+65 → +60（翌日も92%を維持）
- **Day82〜83**（09/20〜09/21）：+40 → +40（翌日も100%を維持）
- **Day87〜88**（09/25〜09/26）：+45 → +40（翌日も89%を維持）

最も強烈だったのは、**2日間で+125人**（+65→+60）を記録したクラスター。普段の1日平均が+22人なので、**約3倍のペース**が2日間続いたことになります。
...
- **Day45**（08/14）：**+55人**（翌日は+30で55%に低下）
- **Day61**（08/30）：**+45人**（翌日は+30で67%に低下）
...
- **1,000人到達**（Day60・08/29）：到達後3日間の平均+34人/日（全体平均の**1.5倍**）
- **2,000人到達**（Day90・09/28）：到達後3日間の平均+35人/日（全体平均の**1.6倍**）
...
90日分のデータを振り返って改めて思ったのは、**フォロワーが増える日には必ず理由がある**ということ。
...
*この記事のデータ分析にはPythonを使用しました。90日分の日次フォロワー増減データを元に、スパイク日の前後コンテキスト・曜日・マイルストーン近接度から投稿パターンを分類しています。*
